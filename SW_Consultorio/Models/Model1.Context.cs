...
namespace SW_Consultorio.Models
{
    ...
    public partial class DB_SWCDEntities : DbContext
    {
        ...
        public virtual ObjectResult<SP_DatosPaciente_Result> SP_DatosPaciente(Nullable<int> id)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_DatosPaciente_Result>("SP_DatosPaciente", idParameter);
        }
        ...
        public virtual ObjectResult<SP_ObtenerLlamados_Result> SP_ObtenerLlamados(Nullable<int> id)
        {
            var idParameter = id.HasValue ?
                new ObjectParameter("id", id) :
                new ObjectParameter("id", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_ObtenerLlamados_Result>("SP_ObtenerLlamados", idParameter);
        }
    }
}
