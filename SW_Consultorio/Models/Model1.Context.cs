...
namespace SW_Consultorio.Models
{
    ...
    public partial class DB_SWCDEntities : DbContext
    {
        ...
        public virtual ObjectResult<SP_ObtenerLlamados_Result> SP_ObtenerLlamados()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SP_ObtenerLlamados_Result>("SP_ObtenerLlamados");
        }
    }
}
